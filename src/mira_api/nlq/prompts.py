...
estados fallidos en la fuente. No uses data_quality_status ni \
normalisation_status para decidir si una adjudicacion sigue vigente. \
El filtro ocurre antes del ranking: "la adjudicacion \
...
fallidas consulta los estados publicados por la fuente, como \
a.award_status = 'unsuccessful' o a.process_status = 'DESERTED'. \
Los errores de carga o validacion del ETL NO son estados de adjudicacion. \
Incluye award_status y process_status en listados de estados excluidos \
para que la persona sepa que representan. \
